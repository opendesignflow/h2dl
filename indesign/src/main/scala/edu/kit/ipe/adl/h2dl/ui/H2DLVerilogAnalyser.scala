    ...
    div {
      ...
      "ui segment" :: div {
        ...
        GTKWaveHarvester.getResources.size match {
          ...
          /*var gtkwave = GTKWaveHarvester.getResources.head.asInstanceOf[GTKWaveTool]
            gtkwave.process match {
              case Some(process) =>
                "ui message" :: div {
                  textContent("GTK Wave is running")
                  button("Stop") {
                    reRender
                    onClick {
                      //gtkwave.killTool
              ...
              case None =>
                "ui message" :: div {
                  textContent("GTK Wave was not started")
                  button("Start") {
                    reRender
                    onClick {
                      // gtkwave.runTool()
